...
fun LifacApp(
    ...
    LifacTheme {
        LifacAppScreen(
            ...
            onConceptNameChanged = viewModel::updateConceptName,
            onConceptDescriptionChanged = viewModel::updateConceptDescription,
            onConceptUnitPriceChanged = viewModel::updateConceptUnitPrice,
            onConceptTaxModeChanged = viewModel::updateConceptTaxMode,
            onSaveConcept = viewModel::saveConcept,
            onResetConceptForm = viewModel::resetConceptForm,
            ...
            onUseConceptForDraft = viewModel::useConceptInDraft,
            onOpenConceptsForDraft = viewModel::openConceptsForDraft,
